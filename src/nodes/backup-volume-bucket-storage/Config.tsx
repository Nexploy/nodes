...
import { useNodeEnvironmentId, useNodeResource, useNodeVolumes } from '@nexploy/nodes/ui/adapter';
...
import { type BucketStorageAccountInfo } from '@nexploy/nodes/core/hostResponses';
